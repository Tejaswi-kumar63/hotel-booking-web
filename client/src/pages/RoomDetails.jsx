...
const onSubmitHandler = async (e) => {
  ...
  try {
    if (!isAvailable) {
      return checkAvailability(); // Assume this sets isAvailable via state if needed
    }
...
justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0, 0.15)] p-6_rounded-x1
...
<div className='flex flex-col'>
<label htmlFor="guests" className='font-medium' >Guests</
label>
...
<div className='max-w-3x] border-y border-gray-300 my-15 py-10 text-gray-500'>
...
<div>
<p className='text-1g md: text-xl' >Hosted by {room. hotel. name} </p>
