...
const onSubmitHandler = async (event) => {
  ...
  return (
    <div onClick={()=> setShowHotelReg(false)} className="fixed top-0 bottom-0 left-0 right-0 z-50 flex items-center justify-center bg-black/70">
      <form  onSubmit={onSubmitHandler} onClick={(e)=> e.stopPropagation()} className="flex bg-white rounded-xl max-w-4xl max-md:mx-2 overflow-hidden">
        <img
          src={assets.regImage}
          alt="reg-image"
        ...
        <div className="relative flex flex-col items-center md:w-1/2 p-8 md:p-10">
          <img
            ...
            alt="close-icon"
            className="absolute top-4 right-4 h-4 w-4 cursor-pointer" onClick={()=>{
              setShowHotelReg(false)
            }}
          />
...
<label htmlFor="name" className="font-medium text-gray-500"> Hotel Name
</label>
...
<div className='w-full mt-4'>
<label htmlFor="contact" className="font-medium text-gray-500"> Phone
</label>
...
<div className='w-full mt-4'>
<label htmlFor="address"  className="font-medium text-gray-500"> Address
</label>
